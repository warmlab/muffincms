...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI =  'postgresql+psycopg2://%s:%s@127.0.0.1:5432/muffincms_dev' % (DB_USER, DB_PASSWORD)
...
class TestingConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI =  'postgresql+psycopg2://%s:%s@127.0.0.1:5432/muffincms_test' % (DB_USER, DB_PASSWORD)
    SQLALCHEMY_TRACK_MODIFICATIONS = False
...
class ProductionConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI =  'postgresql+psycopg2://%s:%s@127.0.0.1:5432/muffincms' % (DB_USER, DB_PASSWORD)
    SQLALCHEMY_TRACK_MODIFICATIONS = False
